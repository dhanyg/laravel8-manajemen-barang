...
@section('title', 'Barang - SemBarang')
@section('content')
    <!-- Page header -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="mb-2 row justify-content-between">
                        <div class="col-md-6">
                            <a href="{{ route('barang.create') }}" class="btn btn-primary">Tambah
                                Data</a>
                        </div>
                    </div>
                    <div class="card">
                                    ...
                                    <tbody>
                                        @foreach ($barang as $key => $row)
                                            <tr>
                                                ...
                                                <td>{{ $row->nama }}</td>
                                                <td><a
                                                        href="{{ route('kategori.item.index', $row->kategori->id) }}">{{ $row->kategori->nama }}</a>
                                                </td>
                                                <td>
                                                    <a href="{{ route('barang.show', $row->id) }}">Detail</a>
                                                    <span>|</span>
                                                    <a href="{{ route('barang.edit', $row->id) }}">Edit</a>
                                                    <span>|</span>
