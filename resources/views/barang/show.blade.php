    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12">
                <div class="mb-2 row justify-content-between">
                    ...
                    <div class="col-md-6">
                        <div class="float-end">
                            ...
                            <a href="#" class="btn btn-danger btn-hapus" data-bs-toggle="modal" data-bs-target="#hapusBarang">
                                <form class="d-inline-block" action="{{ route('barang.destroy', $barang->id) }}" method="post">
                                    Hapus
                                    @csrf
                                    @method('delete')
                                </form>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <img class="img-fluid img-thumbnail" src="{{ asset('storage/' . $barang->gambar) }}" alt="{{ $barang->nama }}" style="object-fit: cover">
                    </div>
                    <div class="col-md-8">
                        <div class="card p-5">
                            <h2 class="fs-1">{{ $barang->nama }}</h2>
                            <div>
                                <a href="{{ route('kategori.item.index', $barang->id_kategori) }}" class="btn btn-sm btn-info rounded-pill px-3 py-1">{{ $barang->kategori->nama }}</a>
                            </div>
                            <div class="mt-3">
                            ...
                            <div class="mt-3 text-secondary">
                                ...
                                <span>|</span>
                                <span>Disunting oleh:
                                    {{ $barang->penyunting == '' ? '-' : $barang->penyunting }}</span>
                            </div>
                        </div>
                    </div>
                </div>
