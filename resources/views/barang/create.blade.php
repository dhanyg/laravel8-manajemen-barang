...
@section('title', 'Tambah Barang - SemBarang')
@section('content')
    <!-- Page header -->
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('deskripsi') is-invalid @enderror" name="deskripsi" id="deskripsi" rows="10">{{ old('deskripsi') }}</textarea>
                                            @error('deskripsi')
                                                <div class="invalid-feedback mt-2">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            <img class="img-fluid" id="previewGambar" />
                                        </div>
                                    </div>
                                </div>
